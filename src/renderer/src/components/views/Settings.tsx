    ...
    <div className="flex flex-col h-full overflow-hidden bg-bg-surface theme-transition animate-page-enter">
      ...
      <div className="p-4 overflow-y-auto max-w-3xl pb-12 custom-scrollbar">
        ...
        <div className="border border-border-subtle bg-bg-surface rounded-sm mb-4 theme-transition animate-fade-slide-up">
          ...
          <div className="p-4 space-y-4 text-sm">
            <div className="flex items-center justify-between group relative z-20">
              <div>
                <div className="text-text-primary transition-colors duration-200 group-hover:text-accent-blue">
                  {t.dnsProvider}
                </div>
            ...
            <div
              className={`grid transition-all duration-300 ease-in-out ${settings.dns === 'custom' ? 'grid-rows-[1fr] opacity-100 mt-4' : 'grid-rows-[0fr] opacity-0 mt-0'}`}
            >
        ...
        <div className="border border-border-subtle bg-bg-surface rounded-sm theme-transition animate-fade-slide-up">
          ...
          <div className="p-4 space-y-4 text-sm relative z-10">
            <div className="flex items-center justify-between group">
              <div>
                <div className="text-text-primary transition-colors duration-200 group-hover:text-accent-yellow">
                  {t.themeLabel}
                </div>
              ...
              <div className="flex bg-bg-primary border border-border-subtle rounded-sm p-0.5 theme-transition">
                ...
                >
                  <Sun
                    size={12}
                    className={`transition-transform duration-300 ${settings.theme === 'light' ? 'text-accent-yellow' : 'group-hover/btn:rotate-45'}`}
                  />{' '}
                  {t.lightTheme}
                </button>
                <button
                ...
                >
                  <Moon
                    size={12}
                    className={`transition-transform duration-300 ${settings.theme === 'dark' ? 'text-accent-blue' : 'group-hover/btn:-rotate-12'}`}
                  />{' '}
                  {t.darkTheme}
                </button>
              </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border-subtle group">
              ...
              <CustomSelect
                ...
                onChange={(val) => update({ language: val as AppSettings['language'] })}
                options={[
        ...
        <div className="mt-8 border-t border-border-subtle pt-8 animate-fade-slide-up pb-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] bg-bg-hover text-text-muted px-1.5 py-0.5 rounded-sm font-mono uppercase tracking-widest">
                  v1.0.0
                </span>
              </div>

              <p className="text-[11px] text-text-secondary mt-1 leading-tight">{t.creditsDesc}</p>
              ...
              <div className="flex items-center gap-4 mt-3">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-semibold text-text-primary leading-none mt-1">
                    Yasman
                  </span>
                </div>
                ...
                >
                  <span className="text-[9px] font-bold text-text-muted uppercase tracking-wider group-hover:text-accent-blue transition-colors">
                    GitHub
                  </span>
                  <span className="text-xs font-semibold text-text-primary group-hover:text-accent-blue transition-colors leading-none mt-1">
                    Source Code
                  </span>
                </button>
              </div>
          ...
          <div className="mt-8 text-[10px] text-text-secondary uppercase tracking-widest font-semibold">
