...
export const translations = {
  en: {
    ...
    rerunDiagnostics: 'Run Again',
    copyReport: 'Copy Report',
    reportCopied: 'Copied',
    diagnosticsIdle:
      'Check the bundled runtime, ADB access, Android version, and Gnirehtet client state.',
    diagnosticsGenerated: 'Generated',
    diagnosticDevices: 'Device details',
    diagAdbRuntime: 'ADB runtime',
    diagGnirehtetRuntime: 'Gnirehtet runtime',
    diagAdbQuery: 'ADB response',
    diagDeviceAccess: 'Device access',
    diagAndroidVersion: 'Android version',
    diagGnirehtetClient: 'Gnirehtet client',
    gnirehtetInstalled: 'Gnirehtet installed',
    gnirehtetActive: 'VPN client active',
    yes: 'Yes',
    no: 'No',
  ...
  id: {
    ...
    rerunDiagnostics: 'Jalankan Lagi',
    ...
    diagnosticDevices: 'Detail perangkat',
    diagAdbRuntime: 'Runtime ADB',
    diagGnirehtetRuntime: 'Runtime Gnirehtet',
    diagAdbQuery: 'Respons ADB',
    diagDeviceAccess: 'Akses perangkat',
    diagAndroidVersion: 'Versi Android',
    diagGnirehtetClient: 'Klien Gnirehtet',
    gnirehtetInstalled: 'Gnirehtet terpasang',
    gnirehtetActive: 'Klien VPN aktif',
    yes: 'Ya',
    no: 'Tidak',
